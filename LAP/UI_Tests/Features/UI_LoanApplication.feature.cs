...
namespace UI_Tests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("UI_LoanApplication")]
    public partial class UI_LoanApplicationFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "UI_LoanApplication.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "UI_LoanApplication", "\tIn order to avoid silly mistakes\r\n\t\tAs an applicant to a loan\r\n\t\tI want to apply" +
                    " for a online loan\r\n\t\tSo I get a decision on money being lent or not\r\n\r\n\t\tAnd to" +
                    " view online the progress of my application", ProgrammingLanguage.CSharp, ((string[])(null)));
